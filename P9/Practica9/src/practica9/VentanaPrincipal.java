...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dialogoTamaño.setPreferredSize(new java.awt.Dimension(350, 300));
        ...
        barraAtributos2.setPreferredSize(new java.awt.Dimension(500, 100));

        panelBrillo.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 5));
        panelBrillo.setPreferredSize(new java.awt.Dimension(200, 98));
        ...
        panelSliderBrillo.setPreferredSize(new java.awt.Dimension(200, 80));
        ...
        barraAtributos2.add(panelBrillo);

        panelFiltro.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 5));
        panelFiltro.setPreferredSize(new java.awt.Dimension(120, 98));
        ...
        barraAtributos2.add(panelFiltro);
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.MouseListener, java.awt.event.WindowListener, javax.swing.event.ChangeListener {
        FormListener() {}
